        ...
        <section id='four_zero_four'>
            <main className="grid min-h-full place-items-center px-6 py-24 sm:py-72 lg:px-8">
                <div className="text-center">
                    ...
                    <h1 className="mt-4 text-3xl font-bold tracking-tight text-highlight-red sm:text-5xl">Page not found</h1>
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        ...
                        <a href="/" className="text-sm font-semibold text-dark-red">
